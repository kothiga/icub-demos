...
class tutorialPeriodicThread : public yarp::os::PeriodicThread {
  ...
  public:
     ...
     * =========================================================================== */
    tutorialPeriodicThread(std::string robotname, std::string configFile);
...
#endif  //_TUTORIAL_PERIODICTHREAD_H_
